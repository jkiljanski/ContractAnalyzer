...
import com.sciamus.contractanalyzer.reporting.checks.AggregatedReport;
...
public class ChecksServiceController {
    ...
    @RolesAllowed("writer")
    @PostMapping("/checks/batchRun")
    @ResponseBody
    public AggregatedReport runBatchOfChecks(@RequestParam List<String> names, @RequestParam(name = "url") String url)
            throws MalformedURLException {
        return contractChecksService.runAndGetSavedBatchReport(names, url);
    }
